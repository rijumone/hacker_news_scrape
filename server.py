...
@app.route('/api/<source>/comment/<comment_id>', methods=['GET'])
def comment(source, comment_id):
    # Retrieve latest version of comment from Hacker News scrapes
    if request.method == 'GET':
        return hacker_news.get_comment(comment_id, source)


@app.route('/api/<source>/post', methods=['GET'])
def posts(source):
...
def post(source, post_id):
    # Retrieve latest version of post from Hacker News scrapes
    if request.method == 'GET':
        return hacker_news.get_post(post_id, source)


@app.route('/api/<source>/stats/<time_period>/average_comment_count',
    methods=['GET'])
def average_comment_count(source, time_period):
    # Retrieve average comment count from specified Hacker News scrapes
    # ('hour', 'day', 'week', 'all')
    if request.method == 'GET':
        return hacker_news.get_average_comment_count(
            hacker_news.get_feeds(time_period, source))


@app.route('/api/<source>/stats/<time_period>/average_comment_tree_depth',
    methods=['GET'])
def average_comment_tree_depth(source, time_period):
...
@app.route('/api/<source>/stats/<time_period>/average_comment_word_count',
    methods=['GET'])
def average_word_count(source, time_period):
...
@app.route('/api/<source>/stats/<time_period>/average_point_count',
    methods=['GET'])
def average_point_count(source, time_period):
...
@app.route('/api/<source>/stats/<time_period>/comments_highest_word_count',
    methods=['GET'])
def highest_word_count(source, time_period):
...
@app.route('/api/<source>/stats/<time_period>/comment_words',
    methods=['GET'])
def comment_word(source, time_period):
...
@app.route('/api/<source>/stats/<time_period>/deepest_comment_tree',
    methods=['GET'])
def deepest_comment_tree(source, time_period):
...
@app.route('/api/<source>/stats/<time_period>/posts_highest_comment_count',
    methods=['GET'])
def highest_comment_count(source, time_period):
...
@app.route('/api/<source>/stats/<time_period>/posts_highest_point_count',
    methods=['GET'])
def highest_point_count(source, time_period):
...
@app.route('/api/<source>/stats/<time_period>/post_types',
    methods=['GET'])
def post_types(source, time_period):
    # Retrieve count of each type of post from specified Hacker News scrapes
    # ('hour', 'day', 'week', 'all')
    if request.method == 'GET':
        return hacker_news.get_post_types(hacker_news.get_feeds(time_period, source))


@app.route('/api/<source>/stats/<time_period>/title_words',
    methods=['GET'])
def title_word(source, time_period):
...
@app.route('/api/<source>/stats/<time_period>/top_posts', methods=['GET'])
def top_posts(source, time_period):
    ...
    # posts to return
    if request.method == 'GET':
        return hacker_news.get_top_posts(hacker_news.get_feeds(time_period, source))


@app.route('/api/<source>/stats/<time_period>/top_websites',
    methods=['GET'])
def top_website(source, time_period):
    # Retrieve top websites that posts were posted from from specified Hacker
    # News scrapes ('hour', 'day', 'week', 'all'); optional count query param
    # specifies number of websites to return
    if request.method == 'GET':
        return hacker_news.get_top_websites(hacker_news.get_feeds(time_period, source))


@app.route('/api/<source>/stats/<time_period>/users_most_comments',
    methods=['GET'])
def user_most_comments(source, time_period):
...
@app.route('/api/<source>/stats/<time_period>/users_most_posts',
    methods=['GET'])
def user_most_posts(source, time_period):
...
@app.route('/api/<source>/stats/<time_period>/users_most_words',
    methods=['GET'])
def user_most_words(source, time_period):
